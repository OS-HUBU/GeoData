      ...
      tooltip: {
        ...
        formatter: function (params) {
          ...
          if(params.componentSubType ==='scatter'){
            ...
            return `${params.name}</br> developers：${params.value[2].toLocaleString()}`
            // return `${params.name}</br> developers：${_this.$options.filters.scientificNotation(params.value[2])}`;
